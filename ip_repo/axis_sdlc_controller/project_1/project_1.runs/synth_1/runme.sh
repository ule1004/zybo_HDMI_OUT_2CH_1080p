...
HD_PWD='E:/P_2017/SEEDCORE/RTL/V16_3/mcb_axis_sdlc_170327/ip_repo/axis_sdlc_controller/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AXIS_SDLC.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AXIS_SDLC.tcl
