...
HD_PWD='E:/P_2017/SEEDCORE/RTL/FINAL/mcb_rel_1.0_170509/ip_repo/ycbcr444to422/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log convert444to422.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source convert444to422.tcl
