...
HD_PWD='E:/PROJECT_2017/SSTANDARD/RTL/kc705/kc705_sdi_pcie_170117/ip_repo/clk_div_by2/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_div_by2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_div_by2.tcl
