...
HD_PWD='E:/P_2017/SSTD2/ICB/RTL/2nd/SEU/icb_seu_vso_2nd_171130/ip_repo/v_in_duplicate/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log v_in_duplicate.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source v_in_duplicate.tcl
