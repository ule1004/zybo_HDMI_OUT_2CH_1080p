...
HD_PWD='E:/P_2017/SSTANDARD_2/ICB/RTL/icb_system_170719/ip_repo/v_in_crop_scale_axis/project_1/project_1.runs/axis_bridge_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axis_bridge_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axis_bridge_fifo.tcl
