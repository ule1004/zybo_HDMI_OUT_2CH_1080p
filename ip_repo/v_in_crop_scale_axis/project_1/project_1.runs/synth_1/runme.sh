...
HD_PWD='E:/P_2017/SSTANDARD_2/ICB/RTL/icb_system_170719/ip_repo/v_in_crop_scale_axis/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log v_in_crop_scale_axis.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source v_in_crop_scale_axis.tcl
