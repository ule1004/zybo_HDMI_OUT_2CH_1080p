...
HD_PWD='E:/P_2017/SEEDCORE/SIM/user_ip_repo/rs170_tx_out/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rs170_tx_out.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rs170_tx_out.tcl
