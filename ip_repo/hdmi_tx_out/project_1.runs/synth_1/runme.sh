...
HD_PWD='E:/P_2017/SEEDCORE/RTL/V16_4/mcb_4ch_dma_sdlc_interlace_170413/ip_repo/hdmi_tx_out/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_tx_out.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_tx_out.tcl
