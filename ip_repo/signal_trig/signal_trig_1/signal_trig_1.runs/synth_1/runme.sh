...
HD_PWD='E:/P_2017/SEEDCORE/RTL/FINAL/mcb_rel_1.0_170509/ip_repo/signal_trig/signal_trig_1/signal_trig_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log signal_trig.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source signal_trig.tcl
