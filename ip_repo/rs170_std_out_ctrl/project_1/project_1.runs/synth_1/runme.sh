...
HD_PWD='E:/P_2017/SEEDCORE/RTL/FINAL/mcb_rel_1.0_170509/ip_repo/rs170_std_out_ctrl/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rs170_std_out_ctrl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rs170_std_out_ctrl.tcl
