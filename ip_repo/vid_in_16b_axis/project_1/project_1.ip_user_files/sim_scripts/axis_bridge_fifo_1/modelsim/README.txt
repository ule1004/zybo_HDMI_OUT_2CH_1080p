...
#
# Generated by export_simulation on Thu Jun 29 18:26:32 +0900 2017
#
################################################################################
...
switch to the './axis_bridge_fifo.sh' script.

./axis_bridge_fifo.sh -reset_run
...
./axis_bridge_fifo.sh -noclean_files

For more information on the script, please type './axis_bridge_fifo.sh -help'.
