...
HD_PWD='E:/P_2017/SEEDCORE/RTL/FINAL/mcb_rel_1.0_170509/ip_repo/vid_in_16b_axis/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vid_in_16b_axis.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vid_in_16b_axis.tcl
