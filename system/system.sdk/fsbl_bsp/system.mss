...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = TPG_v_tpg
END
...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = vdma_in_s2mm_axi_vdma_s2mm
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axivdma
 PARAMETER DRIVER_VER = 6.6
 PARAMETER HW_INSTANCE = vdma_out_mm2s_axi_vdma_mm2s
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axivdma
 PARAMETER DRIVER_VER = 6.6
 PARAMETER HW_INSTANCE = vdma_out_mm2s_user_axi_vdma_mm2s
END
