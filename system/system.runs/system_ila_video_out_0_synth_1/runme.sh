...
HD_PWD='C:/Xilinx/workspace/2018.3/zybo_HDMI_IN_OUT/system/system.runs/system_ila_video_out_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_ila_video_out_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_ila_video_out_0.tcl
